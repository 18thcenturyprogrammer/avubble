...
const WalletBalances = (addressAndPrivKey)=>{
    // console.log("===============================================================");
    // console.log("WalletBalances component called");

    // console.log("addressAndPrivKey : ",addressAndPrivKey);
    ...
    const startWatchEvents = (address)=>{
        // console.log("startWatchEvents is called");
    ...
    useEffect(()=>{
        // console.log("addressAndPrivKey updated");
        // console.log("addressAndPrivKey :",addressAndPrivKey);
        // console.log("addressAndPrivKey.addressAndPrivKey :",addressAndPrivKey.addressAndPrivKey);

        if(addressAndPrivKey.addressAndPrivKey.address != undefined && addressAndPrivKey.addressAndPrivKey.address != ""){
            // console.log("addressAndPrivKey.address : ",addressAndPrivKey.address);
            startWatchEvents(addressAndPrivKey.addressAndPrivKey.address);
            updateBalances(addressAndPrivKey.addressAndPrivKey.address);
        }   
    },[addressAndPrivKey]);
    ...
    return (
        <>
            ...
            <Image avatar spaced='right' src='/imgs/avbb_token.png' />
            {avubbleAmount}
            <Label.Detail>AVBB</Label.Detail> 
            </Label>
            <Label as='a' color='teal' image>
